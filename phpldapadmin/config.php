 ...
 */
 $config->custom->session['blowfish'] = 'x9~qsVfZW?5t:YKy0Ouh(%dHB$Z}sPq7<NsGnUBE+y0D}HCK`z;Y392^^;y0l,3q';
...
$servers->setValue('server','name','ldap-service');
$servers->setValue('server','host','ldap-service');

$config->custom->appearance['tree_display_format'] = array('%description', '%rdn');